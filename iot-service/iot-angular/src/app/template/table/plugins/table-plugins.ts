...
export class TablePluginsPage {
  ...
  ngAfterViewInit() {
  	setTimeout(() => {
			this.tableOptions = {
				dom: "<'row mb-3'<'col-md-4 mb-3 mb-md-0'l><'col-md-8 text-right'<'d-flex justify-content-end'fB>>><'table-responsive't><'row align-items-center mt-3'<'mr-auto col-md-6 mb-3 mb-md-0'i><'mb-0 col-md-6'p>>",
