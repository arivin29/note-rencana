import { Component, Input, Output, EventEmitter, OnInit, OnDestroy, OnChanges, SimpleChanges, ViewChild, ElementRef, AfterViewInit, NgZone } from '@angular/core';
...
export class WidgetContainerComponent implements OnInit, OnDestroy, OnChanges, AfterViewInit {
  ...
  // Capture ECharts instance when chart is initialized
  onChartInit(ec: any): void {
    this.echartsInstance = ec;
  }

  // Setup ResizeObserver to detect widget resize
  ...
  // Debounce resize events and trigger chart resize
